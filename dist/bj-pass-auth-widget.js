...
class ConfigManager {
    constructor(userConfig = {}) {
        ...
        this.config = Object.assign(Object.assign({}, this.defaultConfig), userConfig);
    ...
    applyEnvironmentConfig() {
        ...
        return Object.assign(Object.assign({}, this.config), { baseUrl: envConfig.baseUrl, authServer: this.config.authServer || envConfig.defaultAuthServer });
    }
...
class OAuthUrlBuilder {
    ...
    buildAuthorizationUrl(authData) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const codeChallenge = yield CryptoUtils.generateCodeChallenge(codeVerifier);
...
class TokenValidator {
    ...
    verifyAccessToken(accessToken) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const response = yield fetch(this.urlBuilder.buildIntrospectionUrl(), {
                    method: "POST",
                    headers: {
    ...
    fetchJWKS() {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield fetch(this.urlBuilder.buildJWKSUrl());
            if (!response.ok) {
    ...
    verifySignature(token, jwk) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const key = yield window.crypto.subtle.importKey("jwk", jwk, { name: "RSASSA-PKCS1-v1_5", hash: { name: "SHA-256" } }, false, ["verify"]);
                const [header, payload, signature] = token.split(".");
                const signatureData = CryptoUtils.base64UrlToArrayBuffer(signature);
                const data = new TextEncoder().encode(`${header}.${payload}`);
                return yield window.crypto.subtle.verify("RSASSA-PKCS1-v1_5", key, signatureData, data);
            }
            catch (error) {
...
class EnvironmentSelector extends UIComponent {
    ...
    render() {
        if (!this.config.ui.showEnvSelector)
            return;
...
class BackendClient {
    ...
    exchangeCode(code, state) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield fetch(this.config.beUrl, {
                method: "POST",
                headers: Object.assign({ "Content-Type": "application/json" }, this.config.header),
                body: JSON.stringify({
                    code,
                    state,
                    redirect_uri: this.config.redirectUri,
    ...
    exchangeCodeDirect(code, state, urlBuilder) {
        return __awaiter(this, void 0, void 0, function* () {
            const codeVerifier = SessionManager.getItem("code_verifier");
            if (!codeVerifier) {
                throw new Error("Missing code verifier");
            }
            const response = yield fetch(urlBuilder.buildTokenUrl(), {
                method: "POST",
                headers: {
                    "Content-Type": "application/x-www-form-urlencoded",
                },
    ...
    handleBackendAuthResponse(data) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                if (data.status === "success") {
                    // Authentification réussie
                    yield this.handleBackendAuthSuccess(data);
                }
                else {
    ...
    handleBackendAuthSuccess(data) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield this.verifyBackendStatus();
            }
            catch (error) {
    ...
    verifyBackendStatus() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const response = yield fetch(statusUrl.toString(), {
                    method: "GET",
    ...
    getUserInfoFromBackend() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield fetch(userUrl.toString(), {
                method: "GET",
                credentials: "include",
                headers: {
                    Accept: "application/json",
    ...
    logoutFromBackend() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield fetch(logoutUrl.toString(), {
                method: "POST",
                credentials: "include",
                headers: {
                    Accept: "application/json",
...
class BjPassAuthWidget {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (this.config.useBackend) {
                    ...
                    yield this.backendClient.startBackendAuthFlow();
                }
                else {
                    // Fallback vers l'ancienne méthode
                    yield this.startDirectAuthFlow();
                }
            }
            catch (error) {
                this.handleError("auth_flow_error", error.message);
    ...
    startDirectAuthFlow() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const config = this.configManager.get();
            const authData = SessionManager.generateAndStoreAuthData(config.scope);
            const authUrl = yield this.urlBuilder.buildAuthorizationUrl(authData);
            this.popupManager.open(authUrl, () => {
                this.uiManager.setState({ isLoading: false });
                if (!SessionManager.getItem("success")) {
                    this.handleError("popup_closed", "La fenêtre d'authentification a été fermée");
    ...
    handlePopupResponse(queryParams) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield this.exchangeCodeForTokens(code, state);
            }
            catch (error) {
                this.handleError("callback_error", error.message);
            }
    ...
    exchangeCodeForTokens(code, state) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (config.beUrl) {
                    tokenData = yield this.backendClient.exchangeCode(code, state);
                }
                else {
                ...
                // Validate tokens
                yield this.validateTokens(tokenData.data);
                // Success
                SessionManager.clear();
                this.uiManager.setState({ isLoading: false, error: null });
                if (config.onSuccess) {
    ...
    validateTokens(tokenData) {
        return __awaiter(this, void 0, void 0, function* () {
            const config = this.configManager.get();
            // Validate ID token if present
            if (tokenData.id_token && config.scope.includes("openid")) {
                yield this.tokenValidator.validateIdToken(tokenData.id_token);
            }
            // Verify access token if requested
            if (config.verifyAccessToken && tokenData.access_token) {
                yield this.tokenValidator.verifyAccessToken(tokenData.access_token);
            }
        });
    }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (config.useBackend) {
                try {
                    ...
                    return yield this.backendClient.getUserInfoFromBackend();
                }
                catch (error) {
    ...
    logout() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (config.useBackend) {
                try {
                    yield this.backendClient.logoutFromBackend();
                }
                catch (error) {
    ...
    refreshToken() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const response = yield fetch(refreshUrl.toString(), {
                    method: "POST",
                    credentials: "include",
                    headers: {
                        Accept: "application/json",
                ...
                const refreshData = yield response.json();
    ...
    containers.forEach((container) => {
        try {
            const config = container.dataset.bjpassWidget
                ...
                : {};
            config.ui = Object.assign(Object.assign({}, config.ui), { container: `#${container.id}` });
...
class BjPassWidgetFactory {
    ...
    static createWithTheme(theme, config = {}) {
        ...
        return new BjPassAuthWidget(Object.assign(Object.assign({}, config), { ui: Object.assign(Object.assign(Object.assign({}, config.ui), { theme }), themeConfig) }));
    }
}
// =======================
// Plugin System
...
class AnalyticsPlugin {
    ...
    setupAnalytics() {
        ...
        this.widget.startAuthFlow = () => __awaiter(this, void 0, void 0, function* () {
            this.track("auth_started");
            return originalStartAuth();
        });
        this.widget.exchangeCodeForTokens = (code, state) => __awaiter(this, void 0, void 0, function* () {
            try {
                const result = yield originalHandleSuccess(code, state);
...
class RetryPlugin {
    ...
    setupRetryLogic() {
        ...
        this.widget.exchangeCodeForTokens = (code_1, state_1, ...args_1) => __awaiter(this, [code_1, state_1, ...args_1], void 0, function* (code, state, attempt = 1) {
            try {
                return yield originalExchangeCode(code, state);
            }
            catch (error) {
                if (attempt < this.maxRetries && this.shouldRetry(error)) {
                    console.log(`Retry attempt ${attempt}/${this.maxRetries} after ${this.retryDelay}ms`);
                    yield this.delay(this.retryDelay * attempt);
...
class EnhancedBjPassAuthWidget extends BjPassAuthWidget {
    ...
    startAuthFlow() {
        const _super = Object.create(null, {
            startAuthFlow: { get: () => super.startAuthFlow }
        });
        return __awaiter(this, void 0, void 0, function* () {
            this.executeHook("beforeAuthStart");
            try {
                const result = yield _super.startAuthFlow.call(this);
    ...
    exchangeCodeForTokens(code, state) {
        const _super = Object.create(null, {
            exchangeCodeForTokens: { get: () => super.exchangeCodeForTokens }
        });
        return __awaiter(this, void 0, void 0, function* () {
            this.executeHook("beforeTokenExchange", code, state);
            try {
                const result = yield _super.exchangeCodeForTokens.call(this, code, state);
...
//# sourceMappingURL=bj-pass-auth-widget.js.map